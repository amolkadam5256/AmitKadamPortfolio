      ...
      <div className="w-full flex items-center justify-between px-4 py-2 md:px-6 md:py-3">
        ...
        <div className="hidden md:flex items-center space-x-2">
          <motion.a 
            ...
            whileTap={{ scale: 0.95 }}
            className="flex items-center bg-[#000080] text-white px-4 py-2 shadow-lg hover:shadow-xl transition-all duration-300 font-bold text-sm border border-[#000080] group"
          >
            <FaFileDownload className="mr-2 group-hover:scale-110 transition-transform duration-300" />
            RESUME
          </motion.a>
          <motion.a 
                    ...
                    {!item.dropdown ? (
                      <NavLink
                        ...
                        className={({ isActive }) => 
                          `block py-4 px-2 text-lg font-medium transition-all duration-300 ${
                            isActive ? "text-[#000080] bg-[#FFD700] font-bold border-l-4 border-[#000080]" : "text-gray-700 hover:text-[#000080] hover:bg-gray-50 border-l-4 border-transparent"
                          }`
                        }
                      >
                        {item.name}
                      ...
                      <div className="border-l-4 border-transparent">
                        <button
                          ...
                          className={`flex items-center justify-between w-full text-lg font-medium px-2 py-4 ${
                            isActivePath(item.path) ? "text-[#000080] font-bold border-l-4 border-[#000080]" : "text-gray-700 border-l-4 border-transparent"
                          }`}
                        >
                          {item.name}
                              ...
                              {item.dropdown.map((drop, idx) => (
                                <li key={idx}>
                                  <NavLink
                                    ...
                                    className={({ isActive }) => 
                                      `block py-3 px-6 transition-all duration-300 border-l-4 ${
                                        isActive ? "text-white bg-[#000080] font-bold border-[#FFD700]" : "text-gray-700 hover:text-black hover:bg-[#FFD700] border-transparent"
                                      }`
                                    }
                                  >
                                    {drop.name}
